...
public class VersaPlayerControlsCoordinator: View, VersaPlayerGestureRecieverViewDelegate {
    ...
    open func didTap(at point: CGPoint) {
        if controls.behaviour.isOtherButtonClicked == false{
