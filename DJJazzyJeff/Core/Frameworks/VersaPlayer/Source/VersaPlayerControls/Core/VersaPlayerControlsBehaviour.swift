...
open class VersaPlayerControlsBehaviour {
    ...
    public var isOtherButtonClicked: Bool = false
    ...
    open func defaultActivationBlock() {
        NotificationCenter.default.post(name: .activationBlock, object: nil, userInfo: nil)
    ...
    open func defaultDeactivationBlock() {
        NotificationCenter.default.post(name: .deactivationBlock, object: nil, userInfo: nil)
